...
public abstract class Result<T> {
  ...
  public abstract Result<T> filter(Predicate<T> predicate, String message);
  ...
  public static <T> Result<T> failure(String message, Exception e) {
    return new Failure<T>(new Exception(message, e));
  }
  ...
  private static class Failure<T> extends Result<T> {
    ...
    @Override
    public String toString() {
      return String.format("Failure: %", this.exception);
    }
  }
